  ...
  class BetterTube < Liquid::Tag
    ...
    def render(context)
      ...
      if @ytid
        ...
        thumbnail = "<figure class='BetterTube' data-youtube-id='#{id}' data-player-width='#{w}' data-player-height='#{h}' id='#{id}' style='padding-bottom: #{padding_bottom}'><a class='BetterTubePlayer' href='//www.youtube.com/watch?v=#{id}' style='background: url(//img.youtube.com/vi/#{id}/hqdefault.jpg) 50% 50% no-repeat rgb(0, 0, 0);'></a><div class='BetterTube-playBtn' data-youtube-id='#{id}'></div>&nbsp;</figure>"
