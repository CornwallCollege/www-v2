...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rack>.freeze, ["< 2", "> 1"])
      s.add_runtime_dependency(%q<sprockets>.freeze, ["< 3.7", "~> 3.3"])
      ...
      s.add_runtime_dependency(%q<extras>.freeze, ["~> 0.1"])
      ...
      s.add_dependency(%q<rack>.freeze, ["< 2", "> 1"])
      s.add_dependency(%q<sprockets>.freeze, ["< 3.7", "~> 3.3"])
      ...
      s.add_dependency(%q<extras>.freeze, ["~> 0.1"])
